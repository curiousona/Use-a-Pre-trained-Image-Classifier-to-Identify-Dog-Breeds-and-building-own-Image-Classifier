...
def main():
    ...
    # This function retrieves 3 Command Line Arguments from the user as input from
    ...
    # the model can correctly classify dog images as dogs (regardless of breed)
    adjust_results4_isadog(results, in_arg.dogfile)
    ...
    # Calculates results of the run and puts statistics in the Results Statistics
    ...
    # Print total elapsed runtime in hh:mm:ss format
